...
#ifndef _SENSOR_MSGS_MSG_IMAGE_PUBSUBTYPES_H_
#define _SENSOR_MSGS_MSG_IMAGE_PUBSUBTYPES_H_
...
#error Generated Image is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace sensor_msgs
{
    namespace msg
    {
         ...
         * @ingroup IMAGE
         */
        class ImagePubSubType : public eprosima::fastrtps::TopicDataType {
        public:
            typedef Image type;
...
#endif // _SENSOR_MSGS_MSG_IMAGE_PUBSUBTYPES_H_