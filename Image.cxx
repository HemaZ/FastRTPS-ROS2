...
{
    // m_header com.eprosima.fastrtps.idl.parser.typecode.StructTypeCode@6eda5c9

    // m_height com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55b7a4e0
    m_height = 0;
    // m_width com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5f058f00
    m_width = 0;
    // m_encoding com.eprosima.idl.parser.typecode.StringTypeCode@192d43ce
    m_encoding ="";
    // m_is_bigendian com.eprosima.idl.parser.typecode.PrimitiveTypeCode@72057ecf
    m_is_bigendian = 0;
    // m_step com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1afd44cb
    m_step = 0;
    // m_data com.eprosima.idl.parser.typecode.SequenceTypeCode@6973b51b
...
size_t sensor_msgs::msg::Image::getMaxCdrSerializedSize(size_t current_alignment)
{
...
size_t sensor_msgs::msg::Image::getCdrSerializedSize(const sensor_msgs::msg::Image& data, size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void sensor_msgs::msg::Image::serialize(eprosima::fastcdr::Cdr &scdr) const
{
...
void sensor_msgs::msg::Image::deserialize(eprosima::fastcdr::Cdr &dcdr)
{
 ...
 */
void sensor_msgs::msg::Image::data(const std::vector<uint8_t> &_data)
{
m_data = _data;
}
 ...
 */
void sensor_msgs::msg::Image::data(std::vector<uint8_t> &&_data)
{
...
size_t sensor_msgs::msg::Image::getKeyMaxCdrSerializedSize(size_t current_alignment)
{
...
void sensor_msgs::msg::Image::serializeKey(eprosima::fastcdr::Cdr &scdr) const
{
	(void) scdr;
